...
The [portrait painting](./img/misc/santa_portrait.png) in Jack's studio was a key plot item in last year's events. It features Ed Skoudis as Santa Claus and was painted by Ed's daughter Jessica Skoudis. The initials on the portrait not only refer to *Jack Frost: Santa*, as per the narrative, but are in fact Jessica's initials. The items on the desk are references to [past Holiday Hack Challenges](https://holidayhackchallenge.com/past-challenges/).
